...
if(isset($_REQUEST['id'])){
    ...
    //var_dump($run_sql);
    ?>
    <form method="post" action="updatercvbox.php" onsubmit="return confirm('Submit this data ?')">
        <div class="modal-content">
				<div class="modal-header">
				   <div class="box-header">
						<h3 class="box-title">Received Transmittal Box No: <b><?php echo $box_no; ?></b></h3>
				   </div>
				...
				<div class="modal-body">
				  <div class="card-body">
					 <div class="card card-info">
					   ...
					   <input type="hidden" class="form-control" name="status" value="Checked-<?php echo date("m-d-Y"); ?>" readonly>
						<div class="card-body">
							<div class="row">
                                <div class="col-sm-6">
                                    <!-- text input -->
                            ...
                            <div class="row">
								<div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="date_rcv" class="form-control" placeholder="YYYY/MM/DD" value="" required />
                                    </div>
                                </div>		
								<div class="col-sm-6">
                                    <div class="form-group">
                                        <label>REMARKS</label>
                                        <input type="text" name="remarks" class="form-control" placeholder="If may lackings or wala sa box lagay nyo dito description" required />
                                    </div>
                                </div>						
							</div>
						</div>
